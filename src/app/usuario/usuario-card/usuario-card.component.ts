...
@Component({
  ...
  selector: 'usuario-card',  // Define o seletor para ser utilizado no HTML de outros componentes.
  templateUrl: 'usuario-card.component.html',  // Especifica o arquivo do template HTML do componente.
  styleUrl: 'usuario-card.component.sass',  // Define o arquivo de estilos utilizado pelo componente.
